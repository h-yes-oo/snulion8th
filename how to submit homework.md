...
$ cd snulion8th
$ git pull
$ git checkout -b jeonghyeon origin/jeonghyeon       <-- 자기 이름으로 된 브랜치 가져오기
$ git remote add upstream https://github.com/hyesoo5115/snulion8th.git  <--원본 레포지토리를 upstream이라는 이름으로 추가
```
3. 본인의 레포지토리인 `everglowJH/snulion8th`에 수업 내용 및 과제 commit & push
4. 과제 완료 시 `hyesoo5115/snulion8th`의 **jeonghyeon** 브랜치로 Pull Request 요청
