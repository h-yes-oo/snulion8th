    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sns', models.CharField(blank=True, max_length=30)),
                ('birth', models.CharField(blank=True, max_length=13)),
                ('follows', models.ManyToManyField(related_name='followed', through='accounts.Follow', to='accounts.Profile')),
