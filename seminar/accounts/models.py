...
class Profile(models.Model):
    ...
    sns = models.CharField(max_length=30, blank=True)
    birth = models.CharField(max_length=13, blank=True)
    follows = models.ManyToManyField('self', through='Follow', related_name='followed', symmetrical=False)
